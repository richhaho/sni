...
class ResearchController extends Controller
{
    ...
    public function index()
    {
        ...
        $jobs = Job::query()->where('status', '!=', 'closed')->where('research_complete', null)->whereHas('workorders', function ($p) use ($user_id) {
    ...
    public function edit($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.edit', session('research_job_id'));
        }
        ...
        return view('admin.research.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->input('workorder') == '') {
            ...
            return redirect()->route('research.edit', $job->id);
        } else {
    ...
    public function wizardStep1($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step1', session('research_job_id'));
        }
        ...
        return view('admin.research.wizard.step1', $data);
    }
    ...
    public function wizardStep1Update(Request $request, $id)
    {
        ...
        return redirect()->route('research.wizard.step2', $job->id);
    }
    ...
    public function wizardStep2($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step2', session('research_job_id'));
        }
        ...
        return view('admin.research.wizard.step2', $data);
    }
    ...
    public function wizardStep2Update(Request $request, $id)
    {
        ...
        $job = Job::findOrFail($id);
        if (! $job->firstWorkorder()) {
            Session::flash('message', 'The first work order does not exist.');
    ...
    public function wizardStep3($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step3', session('research_job_id'));
        }
        $existsJob = Job::where('id', $id)->get();
        if (count($existsJob) < 1) {
            Session::flash('message', 'Job '.$id.' has been deleted already.');
        ...
        return view('admin.research.wizard.step3', $data);
    }
    ...
    public function wizardStep3Update(Request $request, $id)
    {
        ...
        return redirect()->route('research.wizard.step4', $id);
    }
    ...
    public function wizardStep4($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step4', session('research_job_id'));
        }
        $existsJob = Job::where('id', $id)->get();
        if (count($existsJob) < 1) {
            Session::flash('message', 'Job '.$id.' has been deleted already.');
        ...
        return view('admin.research.wizard.step4', $data);
    }
    ...
    public function wizardStep4Update(Request $request, $id)
    {
        ...
        return redirect()->route('research.wizard.step5', $id);
    }
    ...
    public function wizardStep5($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step5', session('research_job_id'));
        }
        $existsJob = Job::where('id', $id)->get();
        if (count($existsJob) < 1) {
            Session::flash('message', 'Job '.$id.' has been deleted already.');
        ...
        return view('admin.research.wizard.step5', $data);
    }
    ...
    public function wizardStep6($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step6', session('research_job_id'));
        }
        ...
        return view('admin.research.wizard.step6', $data);
    }
    ...
    public function wizardStep7($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step7', session('research_job_id'));
        }
        ...
        return view('admin.research.wizard.step7', $data);
    }

    public function wizardStep7Update(Request $request, $id)
    {
        return redirect()->route('research.wizard.step8', $id);
    }
    ...
    public function wizardStep8($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step8', session('research_job_id'));
        }
        ...
        return view('admin.research.wizard.step8', $data);
    }
    ...
    public function wizardStep9($id)
    {
        ...
        if (session('research_job_id') != $id) {
            return redirect()->route('research.wizard.step9', session('research_job_id'));
        }
        ...
        return view('admin.research.wizard.step9', $data);
    }
    ...
    public function editParty(Request $request, $job_id, $id)
    {
        ...
        return view('admin.research.wizard.editparty', $data);
    }
    ...
    public function updateParty(Request $request, $job_id, $id)
    {
        ...
        return $from == 'stepedit' ? redirect()->to(route('research.edit', $job_id).'?#parties') : redirect()->route('research.wizard.'.$from, $job_id);
    }
    ...
    public function storeParty(Request $request, $job_id)
    {
        ...
        if ($from == 'edit') {
            return redirect()->to(route('research.edit', $job_id).'?#parties');
        } else {
            return redirect()->route('research.wizard.'.$from, $job_id);
        }
    }
    ...
    public function copyParty(Request $request, $job_id, $id)
    {
        ...
        return $request->from == 'stepedit' ? redirect()->to(route('research.edit', $job_id).'?#parties') : redirect()->back();
    }
    ...
    public function uploadattachment($id, Request $request)
    {
        ...
        return $request->from == 'research_edit' ? redirect()->to(route('research.edit', $id).'?#attachments') : redirect()->back();
    }
    ...
    public function destroy_attachment($id, Request $request)
    {
        ...
        return $request->from == 'research_edit' ? redirect()->to(route('research.edit', $job_id).'?#attachments') : redirect()->back();
    }
    ...
    public function select_property(Request $request, $id)
    {
        ...
        if (strpos($job->folio_number, $legal->apn_original) === false) {
            if ($job->folio_number) {
                $job->folio_number = $job->folio_number.'/';
            }
        ...
        foreach ($sales as $sale) {
            if ($sale->date && $sale->date > $recent_date) {
                ...
                if ($sale->deed_book) {
                    $deed_book = $sale->deed_book;
                }
                if ($sale->deed_page) {
                    $deed_page = $sale->deed_page;
                }
            }
        }
        ...
        for ($i = 0; $i < count($owners); $i++) {
            if ($owners[$i]->address || ! $owners[$i]->last_name) {
                continue;
            }
            for ($j = 0; $j < count($owners); $j++) {
                if ($i == $j || ! $owners[$j]->address) {
                    continue;
                }
        ...
        for ($i = 0; $i < count($owners); $i++) {
            ...
            for ($j = $i + 1; $j < count($owners); $j++) {
                if ($owners[$j]->name == '' || ! $owners[$j]->address) {
                    continue;
                }
                ...
                if ($entity_contact->firm_name == strtoupper($owner->name) && $contact->first_name == $first_name && $contact->last_name == $last_name && (substr($contact->address_1, 0, 5) == strtoupper(substr($owner->address, 0, 5)) || $contact->address_1 == $owner->address) && $contact->city == strtoupper($owner->city) && $contact->zip == $owner->zip_code) {
                    ...
                    if (count($landowners) > 0) {
                        foreach ($landowners as $landowner) {
                            $landowner_deed_number = '';
                            if ($deed_book) {
                                $landowner_deed_number = "Book: $deed_book";
                            }
                            if ($landowner_deed_number) {
                                $landowner_deed_number = $landowner_deed_number.' and ';
                            }
                            if ($deed_page) {
                                $landowner_deed_number = $landowner_deed_number." Page: $deed_page";
                            }
