...
class JobPartiesController extends Controller
{
    ...
    public function index($job_id)
    {
        ...
        return view('researcher.jobparties.index', $data);
    }
    ...
    public function store(Request $request, $job_id)
    {
        ...
        if ($request->exists('first_name')) {
            $this->validate($request, [
                ...
                'first_name' => 'required_without:firm_name',
                'last_name' => 'required_without:firm_name',
            ...
            if ($contact->is_hot) {
                ...
                if ($existent_contact) {
                    ...
                    $existent_entity = Entity::where('hot_id', $contact->entity->id)->first();
                    if ($existent_entity) {
    ...
    public function edit($job_id, $id)
    {
        ...
        return view('researcher.jobparties.edit', $data);
    }
    ...
    public function additionalForm($party_type)
    {
        switch ($party_type) {
            ...
            case 'general_contractor':
                ...
                break;
            case 'bond':
                return view('researcher.jobparties.dynamicforms.bond');
                break;
            case 'landowner':
                return view('researcher.jobparties.dynamicforms.landowner');
                break;
            case 'leaseholder':
                return view('researcher.jobparties.dynamicforms.leaseholder');
                break;
            case 'copy_recipient':
                return view('researcher.jobparties.dynamicforms.copy');
    ...
    public function newContactForm($client_id)
    {
        ...
        return view('researcher.jobparties.dynamicforms.newcontact', $data);
    }
