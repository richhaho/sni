...
class ContactsController extends Controller
{
    ...
    public function index($client_id)
    {
        ...
        $entities = $client->entities()->orderBy('firm_name')->paginate(25);
        ...
        return view('researcher.contacts.index', $data);
    }
    ...
    public function create($client_id)
    {
        ...
        return view('researcher.contacts.create', $data);
    }
    ...
    public function edit($client_id, $id)
    {
        ...
        return view('researcher.contacts.edit', $data);
    }
