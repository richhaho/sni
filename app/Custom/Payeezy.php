...
class Payeezy
{
     ...
     * Generate Payload
     */
    public function getTokenPayload($args = [])
    {
        $args = array_merge([
            'type' => '',
            'auth' => '',
    ...
    public function getPayload($args = [])
    {
        ...
        if ($transaction_type == 'authorize' || $transaction_type == 'purchase') {
        ...
        } elseif ($transaction_type == 'creditGDDAVS' || $transaction_type == 'purchaseGDDAVS') {
            if ($args['method'] == 'token') {
                $token_data = array_merge([
                    'type' => '',
                    'cardholder_name' => '',
            ...
            self::$url = self::$baseURL;
        } elseif ($transaction_type == 'creditGDDSoftDesc' || $transaction_type == 'purchaseGDDSoftDesc') {
            if ($args['method'] == 'token') {
                $token_data = array_merge([
                    'type' => '',
                    'cardholder_name' => '',
            ...
            self::$url = self::$baseURL;
        } elseif ($transaction_type == 'creditGDDL2L3' || $transaction_type == 'purchaseGDDL2L3') {
            if ($args['method'] == 'token') {
                $token_data = array_merge([
                    'type' => '',
                    'cardholder_name' => '',
     ...
     */
    public function getTeleCheckValueLinkPayLoad($args = [])
    {
     ...
     * Purchase Transaction
     */
    public function processPurchaseTransactionWithAVSDirectDebit($args = [])
    {
     ...
     * Credit Transaction
     */
    public function processCreditTransactionWithAVSDirectDebit($args = [])
    {
     ...
     * Purchase Transaction
     */
    public function processPurchaseTransactionWithSoftDescDirectDebit($args = [])
    {
     ...
     * Credit Transaction
     */
    public function processCreditTransactionWithSoftDescDirectDebit($args = [])
    {
     ...
     * Purchase Transaction
     */
    public function processPurchaseTransactionWithL2L3DirectDebit($args = [])
    {
     ...
     * Credit Transaction
     */
    public function processCreditTransactionWithL2L3DirectDebit($args = [])
    {
     ...
     * split Transaction
     */
    public function split_shipment($args = [])
    {
     ...
     * Purchase Transaction
     */
    public function telecheck_purchase($args = [])
    {
     ...
     * Void Transaction
     */
    public function telecheck_void($args = [])
    {
     ...
     */
    public function telecheck_tagged_void($args = [])
    {
        $payload = $this->getTeleCheckValueLinkPayLoad($args, 'void');
        $headerArray = $this->hmacAuthorizationToken($payload);
     ...
     */
    public function telecheck_tagged_refund($args = [])
    {
     ...
     * Purchase Transaction
     */
    public function valuelink_purchase($args = [])
    {
        $payload = $this->getTeleCheckValueLinkPayLoad($args, 'purchase');
        $headerArray = $this->hmacAuthorizationToken($payload);
     ...
     * Refund Transaction
     */
    public function valuelink_refund($args = [])
    {
        $payload = $this->getTeleCheckValueLinkPayLoad($args, 'refund');
        $headerArray = $this->hmacAuthorizationToken($payload);
     ...
     * Void Transaction
     */
    public function valuelink_void($args = [])
    {
        $payload = $this->getTeleCheckValueLinkPayLoad($args, 'void');
        $headerArray = $this->hmacAuthorizationToken($payload);
     ...
     * Cashout Transaction
     */
    public function valuelink_cashout($args = [])
    {
     ...
     * Reload Transaction
     */
    public function valuelink_reload($args = [])
    {
     ...
     */
    public function valuelink_partial_purchase($args = [])
    {
     ...
     */
    public function valuelink_activation($args = [])
    {
     ...
     */
    public function valuelink_deactivation($args = [])
    {
     ...
     */
    public function valuelink_balance_inquiry($args = [])
    {
