...
@section('content')
    {!! Form::open(['route' => ['client.clientusers.update',$user->id], 'method'=> 'PUT','autocomplete' => 'off']) !!}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-xs-12 col-md-4 form-group">
                                    <label>Email:</label>
                                    <input name="email" value="{{ old("email",$user->email)}}" class="form-control" data-toggle="tooltip" data-placement="top" title="">
                                </div>
