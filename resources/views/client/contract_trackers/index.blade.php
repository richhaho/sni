                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12" id="filters-form">
                            {!! Form::open(['route' => 'client.contract_trackers.setfilter', 'class'=>'form-inline'])!!}
                            ...
                            <button class="btn btn-success" type="submit" ><i class="fa fa-filter"></i> Enter</button>
                             <a href="{{ route('client.contract_trackers.resetfilter') }}" class="btn btn-danger">Clear</a>
                            {!! Form::close() !!}
                        ...
                        <div class="col-xs-12" style="margin-bottom: 10px">
                            ...
                            @component('client.contract_trackers.components.createmodal')
                            @endcomponent
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <a href="{{route('client.contract_trackers.download', $tracker->id)}}"><i class="fa fa-download"></i> Download</a>
                                            @endif
                                        </td>
                                        <td>
                                            <?php
                                            ...
                                            ?>
                                            @if($job)
                                            <a href="{{route('client.jobs.edit', $job->id)}}">View Job</a>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="btn-group pull-right dropup">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li><a href="{{route('wizard2.getjobworkorder')}}?contract_tracker={{$tracker->id}}"><i class="fa fa-exchange"></i> Convert To Job and Notice</a></li>
                                                    @endif
                                                ...
                                                @component('client.contract_trackers.components.editmodal')
                                                    @slot('id') 
                                                        {{ $tracker->id }}
                                                    @endslot
                                                    @slot('name') 
                                                    ...
                                                    @endslot
                                                @endcomponent
                                                @component('client.contract_trackers.components.deletemodal')
                                                    @slot('id') 
                                                        {{ $tracker->id }}
                                                    @endslot
                                                @endcomponent
