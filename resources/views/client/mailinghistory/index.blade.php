                ...
                <div class="row">
                    <div class="page-header col-xs-12">
                       ...
                       <div class="col-xs-12" id="filters-form">
                            {!! Form::open(['route' => 'client.mailinghistory.setfilter', 'class'=>'form-inline'])!!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('wo_types',$wo_types,session('mailinghistory_filter.wo_type'),['class'=>'form-control'])!!}
                                </div>
                            ...
                            <button class="btn btn-success" type="submit" ><i class="fa fa-filter"></i> Enter</button>
                             <a href="{{ route('client.mailinghistory.resetfilter') }}" class="btn btn-danger">Clear</a>
                            {!! Form::close() !!}
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if(strlen($mailing->recipient->barcode))
                                        <a href="https://tools.usps.com/go/TrackConfirmAction?tRef=fullpage&tLc=2&text28777=&tLabels={{$mailing->recipient->barcode}}%2C" target="_blank">
                                            {{ $mailing->recipient->barcode }}
                                        </a>
                                        @elseif(strlen($mailing->recipient->mailing_number))
                                        <a href="https://tools.usps.com/go/TrackConfirmAction?tRef=fullpage&tLc=2&text28777=&tLabels={{$mailing->recipient->mailing_number}}%2C" target="_blank">
                                    ...
                                    <td> {{  $mailing->resent_reason}}</td> 
                                    <td>
                                        @if( $mailing->resent <= 0)
                                       
                                            @component('client.mailinghistory.components.deletemodal')
                                            @slot('id') 
                                                {{ $mailing->id }}
                                            @endslot
                                            @slot('button_caption') 
