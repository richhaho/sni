                ...
                <div class="row">
                    <div class="page-header col-xs-12">
                       ...
                       <div class="col-xs-12" id="filters-form">
                            {!! Form::open(['route' => 'client.invoicesbatches.setfilter', 'class'=>'form-inline'])!!}
                            ...
                            <button class="btn btn-success" type="submit" ><i class="fa fa-filter"></i> Enter</button>
                             <a href="{{ route('client.invoicesbatches.resetfilter') }}" class="btn btn-danger">Clear</a>
                            {!! Form::close() !!}
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($batch->payed_at || $batch->type=='autobatch')
                                        <a class="btn btn-danger btn-xs btn-view"   disabled><i class="fa fa-close"></i> &nbsp;&nbsp;Delete&nbsp;&nbsp;</a>
                                        @else
                                        <a class="btn btn-danger btn-xs btn-view btn-delete" href="{{ route('client.invoicesbatches.delete',$batch->id)}}"><i class="fa fa-close"></i> &nbsp;&nbsp;Delete&nbsp;&nbsp;</a>
                                        @endif
                                        @if ($batch->total_amount>0 || !$batch->payed_at)
                                        <a class="btn btn-success btn-xs btn-view btn-pay" href="{{ route('client.invoicesbatches.payment',$batch->id)}}"><i class="fa fa-money"></i> &nbsp;&nbsp;Pay&nbsp;&nbsp;</a>
                                        @else
                                        <a class="btn btn-success btn-xs btn-view"   disabled><i class="fa fa-money" ></i> &nbsp;&nbsp;Pay&nbsp;&nbsp;</a>
                                        @endif

                                        <a class="btn btn-warning btn-xs btn-view" href="{{ route('client.invoicesbatches.printview',$batch->id)}}"><i class="fa fa-print"></i> &nbsp;&nbsp;Print View&nbsp;&nbsp;</a>
                                    </td>
