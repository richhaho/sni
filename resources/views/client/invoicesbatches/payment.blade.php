        ...
        <div id="top-wrapper" >
            ...
            <div  class="col-xs-12">
                <h1 class="page-header">
                    <h1 class="page-header">Invoice Batch : #{{$batch_id}} - {{$batch_date}} --- Invoice{{count($invoices)>1 ? 's' :''}} Payment 
            ...
            <div class="container-fluid">
                ...
                <div class="col-xs-8">
                    {!! Form::open(['route' => 'client.invoicesbatches.submitpayment', 'id' => 'pay-form'])!!}
                    ...
                    <div class="col-xs-4">
                            <button type="submit" class="btn btn-success btn-pay btn-block form-control  pull-right"> <i class="fa fa-money"></i> &nbsp; Pay ${{number_format($total_charge,2)}}
                             @if($todownload) & Downoad @endif</button>
                       
                    </div>
                    <div class="col-xs-4">
                        <a href="{{ route("client.invoicesbatches.index") }}" class="btn btn-danger"><i class="fa fa-close"></i> Cancel</a>
                    </div>
                    </form>
                </div>
