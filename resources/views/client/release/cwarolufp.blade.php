...
<div id="page">
   ...
   @endif
    ...
    <p class="text-justify bold"> This Waiver and Release of Lien Upon Final Payment is expressly conditioned upon receipt of funds upon clearance of any check(s) received as payment, and this waiver shall have no effect if funds are not received.</p>
    ...
    <p>&nbsp;</p>
    <p class="text-justify">Sworn to and subscribed before me this {{ (strlen($sworn_signed_at)) ? Carbon\Carbon::parse($sworn_signed_at)->format('jS \d\a\y\ \o\f\ F\, Y') : ''}}
         by means of ____ physical presence or ____ online notarization by {{$client_name}}, who is _________ personally known to me or _________ produced _______________ as identification, and did take an oath.</p>
