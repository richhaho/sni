                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12" id="filters-form">
                            {!! Form::open(['route' => 'client.research.setfilter', 'class'=>'form-inline'])!!}
                                ...
                                <a href="{{ route('client.research.resetfilter') }}" class="btn btn-danger">Clear</a>
                            {!! Form::close() !!}
                        </div>
                                    ...
                                    <td>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="{{ route('client.research.start',$job->id)}}"><i class="fa fa-book"></i> Start Research</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
