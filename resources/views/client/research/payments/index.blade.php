...
<div class="col-xs-12 col-md-4">
    ...
    {!! Form::open(['route' => ['client.jobpayments.store',$job->id]]) !!}
    ...
    {!! Form::close() !!}
    @else
        {!! Form::open(['route' => ['client.jobpayments.update',$job->id,$xpayment->id], 'method'=> 'PUT', 'id'=> 'edit_payment_form' . $xpayment->id]) !!}
         <div class="col-xs-12 form-group">
             <label>Paid Date: <span class="text-danger">*</span></label>
