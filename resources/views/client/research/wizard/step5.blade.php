...
@section('content')
{!! Form::open(['route' => ['client.research.wizard.step5.update',$job->id], 'method'=> 'PUT', 'id'=> 'wizard_form','autocomplete' => 'off']) !!}
  <div id="top-wrapper" >
    <div class="container-fluid">
      <div  class="col-xs-12">
          <h1 class="page-header">Research Wizard Step 5 
              <div class="pull-right">
                  <a class="btn btn-danger " href="{{ route('client.research.wizard.step4',$job->id) }}"><i class="fa fa-times-circle"></i> Back</a>
                  @if($job->type=='public')
  ...
  <div id="page-wrapper" style="padding-top: 0px">
    <div class="container-fluid row" style="padding-right: 0px">
        <div class="col-xs-12 ">
            <span style="font-size: 22px"><strong>Does the NOC owner match the tax roll owner? Does general description of improvements on NOC match client's materials and/or services?</strong></span>
            <a class="btn btn-success " href="{{ route('client.research.wizard.step6',$job->id) }}"> Yes</a>
