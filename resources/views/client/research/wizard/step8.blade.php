...
@section('content')
      ...
      <div  class="col-xs-12">
          <h1 class="page-header">Research Wizard Step 8 
              <div class="pull-right">
                  <a class="btn btn-danger " href="{{ route('client.research.wizard.step7',$job->id) }}"><i class="fa fa-times-circle"></i> Back</a>
              </div>
          </h1>
          <div class="pull-right">
  ...
  <div id="page-wrapper" style="padding-top: 0px">
    <div class="container-fluid row" style="padding-right: 0px">
        {!! Form::open(['route' => ['client.research.wizard.step8.update',$job->id], 'method'=> 'PUT', 'id'=> 'wizard_form','autocomplete' => 'off']) !!}
        <div class="col-xs-12 ">
            ...
            <a class="btn btn-success " href="{{ route('client.research.wizard.step9',$job->id) }}"> Yes</a>
