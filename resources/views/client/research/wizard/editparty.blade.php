...
@section('content')
            ...
            <div  class="col-xs-12">
                <h1 class="page-header">Edit {{ $parties_type[$job_party->type] }}  <small> from {{ $job_party->job->name }}</small>
                    <div class="pull-right">
                        <button class="btn btn-success btn-save" type="button" form="edit_form"> <i class="fa fa-floppy-o"></i> Save</button>
                        <a class="btn btn-danger " href="{{$from=='stepedit' ? route('client.research.edit',$job_party->job->id).'?#parties' : route('client.research.wizard.'.$from,$job_party->job->id)}}"><i class="fa fa-times-circle"></i> Cancel</a> &nbsp;&nbsp;
                    </div>
                </h1>       
            </div>
            </div>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                @endif
                {!! Form::open(['route' => ['client.research.wizard.parties.update',$job_party->job_id,$job_party->id], 'method'=> 'PUT', 'id'=> 'edit_form','autocomplete' => 'off']) !!}
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12 form-group">
                                        ...
                                        @if(count($job_party->firm->contacts->where('primary',2))>0 || $job_party->contact->hot_id > 0 || $job_party->contact->entity->hot_id>0) 
                                        {!!  Form::text('firm_name',$job_party->firm->firm_name, ['class' => 'form-control','style'=>'pointer-events:none;opacity: 0.7;', 'maxlength'=>'150']) !!}
                                        @else
                                        {!!  Form::text('firm_name',$job_party->firm->firm_name, ['class' => 'form-control', 'maxlength'=>'150']) !!}
                                        @endif
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-md-6 form-group">
                                        ...
                                        {!!  Form::text('first_name',$job_party->contact->first_name, ['class' => 'form-control','style'=>'pointer-events:none;opacity: 0.7;', 'maxlength'=>'50']) !!}
                                        @else
                                        {!!  Form::text('first_name',$job_party->contact->first_name, ['class' => 'form-control', 'maxlength'=>'50']) !!}
                                        @endif
                                    </div>
                                     <div class="col-xs-6 col-md-6 form-group">
                                        <label> Last Name:</label>
                                        @if($job_party->contact->hot_id > 0 )
                                        {!!  Form::text('last_name',$job_party->contact->last_name, ['class' => 'form-control','style'=>'pointer-events:none;opacity: 0.7;', 'maxlength'=>'50']) !!}
                                        @else
                                        {!!  Form::text('last_name',$job_party->contact->last_name, ['class' => 'form-control', 'maxlength'=>'50']) !!}
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-4 form-group">
                                    <label>Phone:</label>
                                    <input name="phone" value="{{ old("phone", $job_party->contact->phone)}}" class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="20">
                                </div>
                              
                                <div class="col-md-12 col-lg-4 form-group">
                                    <label>Mobile:</label>
                                    <input name="mobile" value="{{ old("mobile", $job_party->contact->mobile)}}" class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="20">
                                </div>
                                <div class="col-md-12 col-lg-4 form-group">
                                    <label>Fax:</label>
                                    <input name="fax" value="{{ old("fax", $job_party->contact->fax)}}" class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="20">
                                </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <input name="address_1" value="{{ old("address_1",$job_party->contact->address_1)}}" placeholder="Street and number" class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="150">
                                    </div>
                                </div>
                                
                                <div class="row">
                                    <div class="col-xs-12 form-group">
                                        <input name="address_2" value="{{ old("address_2",$job_party->contact->address_2)}}" placeholder="Apartment, suite, unit, building, floor, etc." class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="150">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-6 form-group">
                                    <label>City:</label>
                                    <input name="city"  value="{{ old("city",$job_party->contact->city)}}" class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="50">
                                </div>
                                    ...
                                    <div class='row'>
                                        <div class="col-xs-12 form-group">
                                            <label>Bond Contract (PDF): 
                                                ...
                                                @else
                                                 <a href="{{ route('client.parties.downloadbond',[$job_party->job_id,$job_party->id]) }}"><i class="fa fa-file"></i> {{$job_party->bond_pdf_filename}}</a>({{ number_format($job_party->bond_pdf_filename_size,2)}}KB)
                                                @endif</label>
