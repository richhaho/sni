...
<div class="modal fade" id="modal-copy-party-{{ $id }}" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
         ...
         {!! Form::open(['url' => route('client.research.wizard.parties.copy',[$job_id,$id])]) !!}
            ...
            <div class="modal-footer">
              ...
              {{ Form::hidden('from', $from) }}
                  ...
                  <button class="btn btn-success btn-copy" type="submit"><i calss="fa fa-times"></i> Copy</button>
...
<script type="text/javascript">
  $('.btn-copy').click(function(){
    ...
    $('.btn-copy').css('pointer-events','none');
}); 
</script>