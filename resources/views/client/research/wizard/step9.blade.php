...
@section('content')
  {!! Form::open(['route' => ['client.research.wizard.finish',$job->id], 'method'=> 'PUT', 'id'=> 'finish_form','autocomplete' => 'off']) !!}
  <div id="top-wrapper" >
    <div class="container-fluid">
      <div  class="col-xs-12">
          <h1 class="page-header">Research Wizard Step 9 
              <div class="pull-right">
                  <a class="btn btn-danger " href="{{ route('client.research.wizard.step8',$job->id) }}"><i class="fa fa-times-circle"></i> Back</a>
  ...
  <div id="page-wrapper" style="padding-top: 0px">
    <div class="container-fluid row" style="padding-right: 0px">
        {!! Form::open(['route' => ['client.research.wizard.step9.update',$job->id], 'method'=> 'PUT', 'id'=> 'wizard_form','autocomplete' => 'off']) !!}
        <div class="col-xs-12 ">
...
$(function () {
    $('.btn-update-job-number').click(function () {
        const url = "{{route('client.research.wizard.step9.number',$job->id)}}";
