...
@section('content')
  {!! Form::open(['route' => ['client.research.wizard.step7.update',$job->id], 'method'=> 'PUT', 'id'=> 'wizard_form','autocomplete' => 'off']) !!}
  <div id="top-wrapper" >
    <div class="container-fluid">
      <div  class="col-xs-12">
          <h1 class="page-header">Research Wizard Step 7 
              <div class="pull-right">
                  <a class="btn btn-danger " href="{{ route('client.research.wizard.step6', $job->id) }}"><i class="fa fa-times-circle"></i> Back</a>
  ...
  <div id="page-wrapper" style="padding-top: 0px">
    <div class="container-fluid row" style="padding-right: 0px">
       <div class="col-xs-12">
            <span style="font-size: 18px"><strong>Any additional parties? Would be located on the NOC or any documents that were pulled over from the clerk's website. Click into job party type as a reference, for example,  lender, owner, GC, lessee, copy. Click into the Source selecting NOC.  Look to see if the copies are already listed in the hotlist before entering, otherwise add to contacts.</strong></span>
       </div>
      <div>&nbsp;</div>
      @if (count($errors) > 0)
