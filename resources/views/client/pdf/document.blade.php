...
@section('content')
            ...
            {!! Form::open(['route'=>['client.pdfpage.generate',$work_order_id],'autocomplete' => 'off','class' => 'form-inline','id'=>'generate','style' => 'display: inline-block;'])!!}
            ...
            {!! Form::close() !!}
            {!! Form::open(['route'=>['client.pdfpage.AttachPDF',$work_order_id],'autocomplete' => 'off','class' => 'form-inline','style' => 'display: inline-block;'])!!}
            ...
            {!! Form::close() !!}
            {!! Form::open(['route'=>['client.pdfpage.preview',$work_order_id],'autocomplete' => 'off','target' => '_blank','class' => 'form-inline','style' => 'display: inline-block;'])!!}
            ...
            {!! Form::close() !!}
            {!! Form::open(['route'=>['client.notices.document.cancel',$work_order_id], 'autocomplete' => 'off','class' => 'form-inline','style' => 'display: inline-block;'])!!}
...
@foreach($pdf_pages as $page)
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.acol',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.acol',$page)
    </div>
    @endif
    
    @if($page['type'] == 'claim-of-lien')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.col',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.col',$page)
    </div>
    @endif
    
     @if($page['type'] == 'conditional-waiver-and-release-of-lien-upon-final-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.cwarolufp',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.cwarolufp',$page)
    </div>
    @endif
    
     @if($page['type'] == 'conditional-waiver-and-release-of-lien-upon-progress-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.cwarolupp',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.cwarolupp',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.cfpa',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.cfpa',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.nob',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.nob',$page)
    </div>
    @endif
    
    @if($page['type'] == 'notice-of-commencement')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.noc',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.noc',$page)
    </div>
    @endif
    @if($page['type'] == 'notice-of-termination')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.not',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.not',$page)
    </div>
    @endif
    
    @if($page['type'] == 'notice-to-owner')
        <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
            @include('client.pdf.nto',$page)
        </div>
        <div class="col-6 form-section">
            @include('client.pdf.forms.nto',$page)
        </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.ntoback',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.ntoback',$page)
    </div>
    @endif

    @if($page['type'] == 'amended-notice-to-owner')
        <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
            @include('client.pdf.anto',$page)
        </div>
        <div class="col-6 form-section">
            @include('client.pdf.forms.anto',$page)
        </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.antoback',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.antoback',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.nococapb',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.nococapb',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.nocol',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.nocol',$page)
    </div>
    @endif
    
    @if($page['type'] == 'notice-of-non-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.nonp',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.nonp',$page)
    </div>
    @endif
    @if($page['type'] == 'notice-of-nonpayment-for-bonded-private-jobs-statutes-713')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.nonp713',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.nonp713',$page)
    </div>
    @endif
    @if($page['type'] == 'notice-of-nonpayment-for-government-jobs-statutes-255')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.nonp255',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.nonp255',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.nonwitlaf',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.nonwitlaf',$page)
    </div>
    @endif
    
    @if($page['type'] == 'out-of-state-nto-preliminary-notice-of-lien-rights')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.pnolr',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.pnolr',$page)
    </div>
    @endif

    @if($page['type'] == 'rescission-letter')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.rl',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.rl',$page)
    </div>
    @endif
    
      @if($page['type'] == 'partial-satisfaction-of-lien')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.psol',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.psol',$page)
    </div>
    @endif
    
    @if($page['type'] == 'satisfaction-of-lien')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.sol',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.sol',$page)
    </div>
    @endif
    
     @if($page['type'] == 'sworn-statement-of-account')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.ssoa',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.ssoa',$page)
    </div>
    @endif

     @if($page['type'] == 'waiver-and-release-of-lien-upon-final-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.warolufp',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.warolufp',$page)
    </div>
    @endif
    
    @if($page['type'] == 'waiver-and-release-of-lien-upon-progress-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.warolupp',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.warolupp',$page)
    </div>
    @endif
    
     @if($page['type'] == 'waiver-of-right-to-claim-against-bond-final-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.wortcabfp',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.wortcabfp',$page)
    </div>
    @endif
    
     @if($page['type'] == 'waiver-of-right-to-claim-against-bond-progress-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('client.pdf.wortcabpp',$page)
    </div>
    <div class="col-6 form-section">
        @include('client.pdf.forms.wortcabpp',$page)
    </div>
    @endif
          ...
          $.ajax({
           ...
           success: function(data)
           {
               if (data =='kicked') {
                    ...
                    window.location.replace("{{ url('client/notices/kickout')}}");
               } else {
