...
<div id="page">
    ...
    <table style="width:100%">
        <tr>
            <td style="width:15%" class="text-left">DATE: {{  date_format(date_create($nto_date ),'F jS, Y')}}</td>
            <td style="width:70%" class="text-center"><h1>AMENDED NOTICE TO OWNER/NOTICE TO CONTRACTOR</h1></td>
            <td style="width:15%" class="text-right">Notice #{{ $wo_number }}<br>
            Original Notice #{{$wo_nto_number}}
            </td>
        </tr>
        <tr>
            ...
            <tr>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            @if($barcode_id != '' && $barcode_key != '') 
                                <div class="barcode">
                                    <div class="text-center">Job Number: {{ $barcode_id }}</div>
                                    <div class="text-center">Job Key: {{ $barcode_key }}</div>
                                </div>
                                <div class="barcode">
                                    <div class="text-center">
                                    <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')
                                        ->size(150)
                                        ->generate(env('APP_URL').'/client/wizard2/job_workorder?number='.$barcode_id.'&key='.$barcode_key)) !!} ">
                                    </div>
                                </div>
                            @endif
                        </div>
