        ...
        <div class="row">
            <div class="col-xs-12">
                <h3 class="page-header">
                    Purchased Postage and Sent for Mailing
                </h3>       
            </div>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class ="col-xs-12">
                ...
                You can view your documents on the "Attachment" tab of the Work Order edit page.
                </p>
            </div>
            <div class ="col-xs-12">
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="{{route('client.notices.edit', $work_id)}}?#attachments" class="btn btn-success pull-right">&nbsp;&nbsp;&nbsp;&nbsp;Goto Attachment tab of Work Order Edit page&nbsp;&nbsp;&nbsp;&nbsp;</a>
                            </div>
                        </div>
                    </div>
                </div>
