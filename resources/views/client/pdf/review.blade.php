...
@section('content')
{!! Form::open(['route' => ['client.invoices.store'],'autocomplete' => 'off']) !!}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                        ...
                        <a href="{{route('client.notices.deleteregenerate', $work_order_id)}}" class="btn btn-danger">No</a> 
                </div>
            </div>
        </div>
    </div>
    ...
    <div  class="col-xs-12">
        <h1 class="page-header">Review
            <div class="pull-right">
                <button class="btn btn-success btn-save" type="submit"> Purchase Postage and Send for Mailing</button>
                <a href="{{route('client.notices.deleteregenerate', $work_order_id)}}" class="btn  btn-warning">Delete These Documents and Generate Again</a> 
                <a href="{{route('client.notices.index')}}" class="btn  btn-danger " ><i class="fa fa-times-circle"></i> Cancel</a> &nbsp;&nbsp;
            </div>
        </h1>       
    </div>
</div>
                    ...
                    <table class="table lines">
                        ...
                        <tr class="new-line-{{$loop->index}}"><td>
                            ...
                            <div class="col-xs-6 form-group">
                                ...
                                <input readonly name="new_description[{{$loop->index}}]" data-newid="{{$loop->index}}" value="{{$val['description']}}" placeholder="Item Descriptions" class="form-control" data-toggle="tooltip" data-placement="top" title="" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label>Quantity</label>
                                <input readonly type="number" data-newid="{{$loop->index}}"  min="1" name="new_quantity[{{$loop->index}}]" value="{{$val['quantity']}}" placeholder="Qty" class="form-control new_qty" data-toggle="tooltip" data-placement="top" title="" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label>Price</label>
                                <input readonly type="number" data-newid="{{$loop->index}}"  name="new_price[{{$loop->index}}]" value="{{$val['price']}}" placeholder="price" step="0.01" class="form-control new_price" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label>Amount</label>
                                <input disabled data-newid="{{$loop->index}}"  type="number" name="new_amount[{{$loop->index}}]" value="{{ round($val['price'] * $val['quantity']*100)/100}}" placeholder="Amount" step="0.01" class="form-control new_amount">
                            </div>
                            </td></tr>
                        @endforeach
                        ...
                        <tr class="new-line-{{$key}}"><td>
                            ...
                            <div class="col-xs-6 form-group">
                                <label>Description</label>
                                <input readonly name="new_description[{{$key}}]" data-newid="{{$key}}" value="{{old('new_description')[$key]}}" placeholder="Item Descriptions" class="form-control" data-toggle="tooltip" data-placement="top" title="" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label>Quantity</label>
                                <input readonly type="number" data-newid="{{$key}}"  min="1" name="new_quantity[{{$key}}]" value="{{old('new_quantity')[$key]}}" placeholder="Qty" class="form-control new_qty" data-toggle="tooltip" data-placement="top" title="" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label>Price</label>
                                <input readonly type="number" data-newid="{{$key}}"  name="new_price[{{$key}}]" value="{{old('new_price')[$key]}}" placeholder="price"  step="0.01" class="form-control new_price" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
                            </div>
                            <div class="col-xs-2 form-group">
                                <label>Amount</label>
...
<div class="new-item-line">
    ...
    <div class="col-xs-6 form-group">
        <label>Description</label>
        <input readonly name="new_description[@i]" data-newid="@i"  value=""  placeholder="Item Descriptions" class="form-control" data-toggle="tooltip" data-placement="top" title="" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
    </div>
    <div class="col-xs-2 form-group">
        <label>Quantity</label>
        <input readonly type="number" min="1" data-newid="@i"  name="new_quantity[@i]" value="" placeholder="Qty" class="form-control new_qty" data-toggle="tooltip" data-placement="top" title="" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
    </div>
    <div class="col-xs-2 form-group">
        <label>Price</label>
        <input readonly type="number" data-newid="@i"  name="new_price[@i]" value="" placeholder="price"  step="0.01" class="form-control new_price" required autofocus onclick="reactivate()" onkeydown="reactivate()" onchange="reactivate()">
    </div>
    <div class="col-xs-2 form-group">
        <label>Amount</label>
