...
<div id="top-wrapper" >
    ...
    <div class="container-fluid">
       @if (count($errors) > 0)
        ...
        <div class ="row">
            <div class ="col-xs-12">
                <p>Your notice has been processed successfully.  You will be notified when your notice is ready. You can review your order Status on My Work Orders menu, You can pay your outstanding balance on 
                    the invoices screen.
                </p>
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="{{route('wizard.getjob')}}" class="btn btn-success pull-right">Create Another Work Order</a>
                            </div>
                        </div>
                    </div>
                </div>
