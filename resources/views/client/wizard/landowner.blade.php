            ...
            <div id="page-wrapper">
                ...
                <div class="stepwizard">
                  <div class="stepwizard-row setup-panel">
                      ...
                      <div class="stepwizard-step col-xs-4">    <a type="button" class="btn btn-success btn-circle">2</a>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="page-header">
                            New Work Order - Property Owner Contact Information<br>
                    ...
                    <div class="col-xs-12 message-box">
                        ...
                        @endif
                    <div class="row">
                      <div class="col-xs-12 text-left"><a href="{{route('wizard.getparties',$job->id)}}" class="btn btn-success">Skip Wizard</a></div>
                        {!! Form::open (['route'=>['wizard.landowner.store',$job->id],'files' => true,'id'=> 'employer_form','autocomplete'=>'off']) !!}
                        {!! Form::hidden('job_id',$job->id) !!}
                        {!! Form::hidden('client_id',$job->client->id) !!}
                        {{ Form::hidden('workorder', $work_order) }}
                        {!!  Form::hidden('type','landowner') !!}
                        <div class="col-md-12 col-lg-12search-contact">

                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Do you know who owns the property?</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-12 form-group">
                                          
                                            <select id="know" name="know" class="form-control" style="width: 100%">
                                    ...
                                    <div class="row ">
                                     ...
                                     <div id="type-fields">
                                        @include('client.wizard.dynamicforms.landowner')
                                    </div>
                                    ...
                                    <div class='row hidden' id="cancelsubmit-new-contact">
                                        ...
                                        <div class="col-xs-6 form-group text-right">
                                             ...
                                             <button type="submit" class="btn btn-success" form="employer_form"> Next </i></button>
                                       </div>
                                    </div>
                                    </div>
                                </div>
