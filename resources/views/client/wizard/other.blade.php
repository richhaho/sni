                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="page-header">
                            New Work Order - Other Contact Information<br>
                    ...
                    <div class="row">
                        ...
                        {!! Form::open (['route'=>['wizard.other.store',$job->id],'files' => true,'id'=> 'employer_form','autocomplete'=>'off']) !!}
                        ...
                        <div class="col-md-12 col-lg-12search-contact">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Is there anyone else who should be notified?</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="row ">
                                     ...
                                     <div id="type-fields">
                                        @include('client.wizard.dynamicforms.copy')
                                    </div>
