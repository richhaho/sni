...
<div class="col-xs-12 col-md-4">
    ...
    {!! Form::open(['route' => ['client.jobpayments.store',$job->id],'files' => true]) !!}
    ...
    <div class="col-xs-12 form-group">
        ...
        {!!  Form::number('amount','', ['class' => 'form-control','step' => '0.01', 'min' => '0','maxlength'=>'13']) !!}
    </div>
     <div class="col-xs-12 form-group">
    ...
    <div class="col-md-12 form-group filegroup">
        ...
        {!!  Form::file('attached_file','', ['class' => 'form-control']) !!}
    </div>
     <div class="col-xs-6 col-xs-offset-6 form-group ">
        <button class="btn btn-success pull-right payment_save" type="submit"> <i class="fa fa-floppy-o"></i> Add Payment</button>
    </div>
    <div class="col-xs-12">
    ...
    {!! Form::close() !!}
    @else
        {!! Form::open(['route' => ['client.jobpayments.update',$job->id,$xpayment->id], 'method'=> 'PUT', 'id'=> 'edit_payment_form' . $xpayment->id,'files' => true]) !!}
         <div class="col-xs-12 form-group">
             <label>Paid Date: <span class="text-danger">*</span></label>
        ...
        <div class="col-xs-12 form-group">
            <label>Amount: <span class="text-danger">*</span></label>
            {!!  Form::number('amount',old('amount',$xpayment->amount), ['class' => 'form-control','step' => '0.01', 'min' => '0','max'=>'99999999.99','oninput'=>'lengthCheck(this)']) !!}
        </div>
         <div class="col-xs-12 form-group">
            <label>Description:</label>
 ...
 <div class="col-md-8">
     @include('client.jobs.payments.list', ['payments' => $payments])
