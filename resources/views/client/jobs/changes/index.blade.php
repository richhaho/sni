...
<div class="col-xs-12 col-md-4">
    ...
    {!! Form::open(['route' => ['client.jobchanges.store',$job->id],'files' => true]) !!}
    ...
    <div class="col-xs-12 form-group">
        ...
        {!!  Form::text('added_on','', ['class' => 'form-control date-picker','id' =>'added_on', 'data-date-format' => 'mm/dd/yyyy']) !!}
    </div>
    <div class="col-xs-12 form-group">
    ...
    <div class="col-md-12 form-group filegroup">
     ...
     <div class="col-xs-6 col-xs-offset-6 form-group ">
        <button class="btn btn-success pull-right change_save" type="submit"> <i class="fa fa-floppy-o"></i> Create Change</button>
    </div>
      <div class="col-xs-12">
    ...
    {!! Form::close() !!}
    @else
        {!! Form::open(['route' => ['client.jobchanges.update',$job->id,$xchange->id], 'method'=> 'PUT', 'id'=> 'edit_change_form' . $xchange->id,'files' => true]) !!}
        <div class="col-xs-12 form-group">
            <label>Number: <span class="text-danger">*</span></label>
