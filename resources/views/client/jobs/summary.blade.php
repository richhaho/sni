                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('client.jobchanges.showattachment',[$change->id])}}"><i class="fa fa-download"></i></a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
                            ...
                            <tbody>
                                ...
                                <td>{{ $pay->description }}</td>
                                    <td>
                                        ...
                                        <a href="{{ route('client.jobpayments.showattachment',[$pay->id])}}"><i class="fa fa-download"></i></a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
        ...
        <div class="col-xs-12" style="margin-top: 20px">
            ...
            <table style="width:100%">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <li>
                                                    ...
                                                    @foreach($work->attachments as $attach)
                                                        ...
                                                        - <a href="{{ route('client.notices.showattachment',[$work->id,$attach->id])}}"><i class="fa fa-download"></i></a> &nbsp;&nbsp;
                                                        @endif    
                                                    @endforeach
                                                </li>
                                                @endforeach
                ...
                <tr>
                    ...
                    <td style="width:80%">
                        @foreach($job->attachments->where('type', '!=', 'generated')->where('clientviewable','yes') as $attach)
                        <a href="{{ route('client.jobs.showattachment',[$job->id,$attach->id])}}"><i class="fa fa-download"></i> {{ $attach->original_name}}</a> &nbsp;&nbsp;&nbsp;
                        @endforeach
                        @foreach($work_orders as $work)
                        @foreach($work->attachments->where('type', '!=', 'generated')->where('clientviewable','yes') as $attach)
                        <a href="{{ route('client.notices.showattachment',[$work->id,$attach->id])}}"><i class="fa fa-download"></i> {{ $attach->original_name}}</a> &nbsp;&nbsp;&nbsp;
                        @endforeach
                        @endforeach
                    </td>
                </tr>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        @if($noc->copy_noc)
                                        <a href="{{route('client.jobnocs.download', [$job->id, $noc->id])}}"><i class="fa fa-download"></i></a>
                                        @endif
                                    </td>
