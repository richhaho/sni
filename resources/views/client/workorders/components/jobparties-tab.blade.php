<div  class="col-xs-12">
    <h1 class="page-header">{{$job->name}}
        <div class="pull-right">
            <a class="btn btn-success " href="{{ route('client.parties.index',$job->id) .'?workorder=' .$work->id }}"> <i class="fa fa-pencil"></i> Edit Parties</a>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           @foreach($job->parties()->ofType($type_key)->get() as $jobparty) 
                                ...
                                @include('client.jobs.components.contacticon')
