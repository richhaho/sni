    ...
    <div class="container-fluid">
        <h1 class="page-header">To Do Uploads and Instructions<br>
            <div class="pull-right">
                ...
                <a href="{{route('client.notices.todo.complete', ['work_id' => $work->id, 'id' => $todo->id])}}" class="btn btn-primary hidden"> Mark Complete</a>
                @endif
                <a class="btn btn-danger " href="{{ route('client.notices.edit',$work->id)}}?#todos"><i class="fa fa-times"></i> Back</a>
            </div>
        </h1>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 panel panel-default">
                ...
                {!! Form::open(['route' => ['client.notices.todo.upload', $todo->id],'files' => true,'class'=>'uploadfile']) !!}
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    @foreach ($todo->documents() as $attach)
                        <div class="col-md-3 text-center">
                            <div class="thumbnail">
                                <img class="img-responsive" src="{{ route('client.notices.todo.document.showTodoThumbnail', $attach->id)}}" alt="{{ $attach->type }}">
                                <div class="caption">
                                    <h5 style="word-wrap: break-word;">{{ $attach->original_name}}</h5>
                                    <p>{{ $attach->description }}</p>
                                        @component('client.workorders.additionalservice.deletetododocumentmodal')
                                            @slot('id') 
                                                {{ $attach->id }}
                                            @endslot
                                            @slot('file_name') 
                                            ...
                                            @endslot
                                        @endcomponent
                                    <a href="{{ route('client.notices.todo.document.download',$attach->id)}}" type="button" class="btn btn-success btn-xs" ><i class="fa fa-download"></i> Download</a>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xs-6 panel panel-default">
                ...
                {!! Form::open(['route' => ['client.notices.todo.instruction', $todo->id]]) !!}
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-xs-12 form-group">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        @if (isset($instruction->writer()->client_id))
                                        @if ($instruction->writer()->client_id!=0)
                                        @component('client.workorders.additionalservice.deletetodoinstructionmodal')
                                            @slot('id') 
                                                {{ $instruction->id }}
                                            @endslot
                                        @endcomponent
