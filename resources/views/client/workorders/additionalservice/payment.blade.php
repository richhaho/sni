...
@section('content')
        ...
        <div id="top-wrapper" >
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="page-header">Additional Services - Submit Payment</h3>
                    </div>
                </div>
            </div>
...
$(".message-box").fadeTo(6000, 500).slideUp(500, function(){
    ...
    $('#payment-form').submit(function(e) {
        ...
        $.ajax({
            url: "{{ route('client.notices.payService', $work->id) }}",
            type: "get",
            data: $.param(serializedData),
            success: function(data) {
                      var obj = jQuery.parseJSON(data);
                      window.location.replace('{{ url("/client/notices/".$work->id."/service/payment/") }}/' + obj.id +'/' + obj.status);
                     },
            error: function() {
