...
<div id="top-wrapper" >
        ...
        <div class="row">
            <div  class="col-xs-12">
                <h3 class="page-header">
                    Additional Service - Payment Decline
                </h3>       
            </div>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12">
                <a href="{{route('client.notices.edit', $work_id)}}?#todos" class="btn btn-success pull-right">&nbsp;&nbsp;&nbsp;&nbsp;Goto ToDo tab of Work Order Edit page&nbsp;&nbsp;&nbsp;&nbsp;</a>
            </div>
        </div>
        <div>&nbsp;</div>
        <div class="row">
            <div class="col-xs-12">
                <a class="btn btn-warning" href="{{ route('client.notices.requestService',$work_id)}}"> Request Additional Services</a>
            </div>
        </div>
    </div>
</div>
