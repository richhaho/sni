  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-left">Delete Todo document</h4>
      </div>
      <div class="modal-body text-left">
          <p>Are you sure you want to delete the uploaded ToDo document:<br> {{ $file_name }}</p>
      </div>
      <div class="modal-footer">
          
        
       {!! Form::open(['url' => route('client.notices.todo.document.destroy',$id)]) !!}
