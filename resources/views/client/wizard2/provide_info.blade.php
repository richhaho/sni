    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <h3 class="page-header">
                Provide work order information<br>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="pull-right">
                        <button type="submit" class="btn btn-success btn-next btn-submit-party-form" form="employer_form"> <i class="fa fa-save"></i> Save</button><br>&nbsp;
                    </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">Who is your contract with?</h4>
                        </div>
                        <div class="panel-body">
                            {!! Form::hidden('from_page','provide_info') !!}
                            {!! Form::hidden('job_id',$job->id) !!}
                            {!! Form::hidden('client_id',$job->client->id) !!}
                            {{ Form::hidden('workorder', $work_order->id) }}
                            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        {!! Form::open(['route' => ['workorder_provide.addattachments',$user_id, $job->id],'files' => true,'class'=>'uploadfile']) !!} 
                        {!! Form::hidden('attach_to','workorder') !!}
                        {!! Form::hidden('to_id',$work_order->id) !!}
