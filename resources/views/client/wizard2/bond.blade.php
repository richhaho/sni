                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="page-header">
                            New Work Order - Bond Contact Information<br>
                    ...
                    <div class="col-xs-12 message-box">
                        ...
                        @endif
                    <div class="row">
                        {!! Form::open (['route'=>['wizard2.bond.store',$job->id],'files' => true,'id'=> 'employer_form','autocomplete'=>'off']) !!}
                        {!! Form::hidden('job_id',$job->id) !!}
                        {!! Form::hidden('client_id',$job->client->id) !!}
                        {{ Form::hidden('workorder', $work_order) }}
                        {!!  Form::hidden('type','bond') !!}
                        <div class="col-md-12 col-lg-12search-contact">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Add Bond Info</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                     ...
                                     <div id="type-fields">
                                        @include('client.wizard2.dynamicforms.bond')
                                    </div>
