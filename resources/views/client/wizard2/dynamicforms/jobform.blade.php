                            ...
                            <div class="panel-body">
                                ...
                                <div class="row job-private">
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <input name="name"  value="{{ old("name", $job->name)}}" class="form-control job-name" data-toggle="tooltip" data-placement="bottom"    title="Descriptive name for the Job" maxlength="200" onchange="enterJobName(this)">
                                        <p class="text-danger {{$job->name ? '':'hidden'}} job-required-field">Everything marked in red must be completed in order to complete this page. However, you can still enter additional information if you have it.</p>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="col-xs-12 form-group">
                                    <label class="requiredfiled">Street Address*:</label>
                                    <input name="address_1" value="{{ old("address_1", $job->address_1)}}" placeholder="Street and number" class="form-control exist-job-address-1" data-toggle="tooltip" data-placement="bottom"  title="First Line for the address" maxlength="200">
                                    <input type="hidden" class="exist-job-address-1-origin" value="{{ old("address_1", $job->address_1)}}">
                                    <p class="text-danger exist-job-address-changed hidden">YOU ARE CHANGING THE JOB SITE OF AN EXISTING JOB - SHOULD THIS BE A NEW JOB?</p>
                                </div>
                                </div>
                                <div class="row">
                                <div class="col-xs-12 form-group">
