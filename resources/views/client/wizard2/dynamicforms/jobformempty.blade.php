        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input name="name"  value="{{ old("name")}}" class="form-control job-name" data-toggle="tooltip"  data-placement="bottom"  title="Descriptive name for the Job" autocomplete="false" maxlength="200" onchange="enterJobName(this)">
                    <p class="text-danger hidden job-required-field">Everything marked in red must be completed in order to complete this page. However, you can still enter additional information if you have it.</p>
                </div>
            </div>
            <div class="row">
