            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-12 message-box">
                        ...
                        @endif
                    <div class="row">
                        {!! Form::open (['route'=>['wizard2.landowner.store',$job->id],'files' => true,'id'=> 'employer_form','autocomplete'=>'off']) !!}
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row ">
                                     ...
                                     <div id="type-fields">
                                        @include('client.wizard2.dynamicforms.landowner')
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="pull-right">
                                <a href="{{route('wizard2.getparties',$job->id)}}" class="btn btn-warning">Skip Wizard</a>
