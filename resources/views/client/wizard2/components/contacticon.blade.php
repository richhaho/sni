<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
    ...
    @endif
        ...
        <div class="controls">
            @component('client.wizard2.components.deletemodal')
                @slot('id') 
                    {{ $jobparty->id }}
                @endslot
                @slot('job_party_name') 
            ...
            <a href="{{ route('wizard2.parties.edit',[ $jobparty->job_id, $jobparty->id])}}" class="btn btn-success btn-xs" role="button" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
            @component('client.wizard2.components.copyparty')
                @slot('id') 
                    {{ $jobparty->id }}
                @endslot
                @slot('job_id') 
