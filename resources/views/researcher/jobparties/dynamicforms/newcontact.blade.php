        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <input name="address_1" value="{{ old("address_1")}}" autocomplete="off" placeholder="Street and number"  class="form-control" data-toggle="tooltip" data-placement="top" title="">
                </div>
                </div>
                <div class="row">
                <div class="col-xs-12 form-group">
                    <input name="address_2" value="{{ old("address_2")}}" autocomplete="off" placeholder="Apartment, suite, unit, building, floor, etc." class="form-control" data-toggle="tooltip" data-placement="top" title="">
                </div>
                </div>
                <div class="row">
                ...
                <div class="col-md-12 form-group hidden">
                    <label>Country:</label>
                    <input id="countries" value="{{ old("country",'USA')}}" autocomplete="off" name="country" class="form-control typeahead" data-toggle="tooltip" data-placement="top" title="" autocomplete="off">
                </div>
               
                <div class="col-md-12 form-group">
                    <label>State / Province / Region:</label>
                    <input id="states" value="{{ old("state",'FL')}}" autocomplete="off" name="state" class="form-control typeahead" data-toggle="tooltip" data-placement="top" title=""  autocomplete="off">
                </div>
                </div>
                ...
                <div class="col-md-12  form-group">
                    <label>City:</label>
                    <input name="city"  value="{{ old("city")}}"  autocomplete="off" class="form-control" data-toggle="tooltip" data-placement="top" title="">
                </div>

                <div class="col-md-12  form-group">
                    <label>Zip code:</label>
                    <input name="zip"  value="{{ old("zip")}}" autocomplete="off" class="form-control" data-toggle="tooltip" data-placement="top" title="">
                </div>
                </div>
