<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
    ...
    @else
    <p><b>Bond book page number:</b> {{ $jobparty->bond_bookpage_number}}</p>
    @endif
    ...
    @endif
        ...
        <div class="controls">
            @component('researcher.jobparties.components.deletemodal')
                @slot('id') 
                    {{ $jobparty->id }}
                @endslot
                @slot('job_party_name') 
            ...
            @endif
             ...
             @component('researcher.jobparties.components.copyparty')
                @slot('id') 
                    {{ $jobparty->id }}
                @endslot
                @slot('job_id') 
