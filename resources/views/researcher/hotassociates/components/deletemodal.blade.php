...
<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-associate-delete-{{ $id }}"><i class="fa fa-times"></i> Delete</button>
 </span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
       ...
       {!! Form::open(['url' => route('hotassociates.destroy',[$entity_id,$id])]) !!}
