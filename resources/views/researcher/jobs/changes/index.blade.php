...
<div class="col-xs-12 col-md-4">
    ...
    {!! Form::open(['route' => ['jobchanges.store',$job->id]]) !!}
    ...
    {!! Form::close() !!}
    @else
        {!! Form::open(['route' => ['jobchanges.update',$job->id,$xchange->id], 'method'=> 'PUT', 'id'=> 'edit_change_form' . $xchange->id]) !!}
        <div class="col-xs-12 form-group">
            <label>Number: <span class="text-danger">*</span></label>
 ...
 <div class="col-md-8">
     @include('researcher.jobs.changes.list', ['changes' => $changes])
