                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12" id="filters-form">
                            ...
                            <button class="btn btn-success" type="submit" ><i class="fa fa-filter"></i> Filter</button>
                             <a href="{{ route('jobs.resetfilter') }}" class="btn btn-danger">Reset</a>
                            {!! Form::close() !!}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        @component('researcher.jobs.components.deletemodal')
                                        @slot('id') 
                                            {{ $job->id }}
                                        @endslot
                                        @slot('client_name') 
                                        ...
                                        @component('researcher.jobs.components.closemodal')
                                        @slot('id') 
                                            {{ $job->id }}
                                        @endslot
                                        @slot('client_name') 
