  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <p>Are you sure you want to delete the job:<br> {{ $client_name }}</p>
      </div>
      <div class="modal-footer">
          
        
        {!! Form::open(['route' => ['jobs.destroy',$id]]) !!}
...
<a href="#" data-toggle="modal" data-target="#modal-job-delete-{{ $id }}" class="btn btn-danger"><i class="fa fa-times"></i> Delete</a>