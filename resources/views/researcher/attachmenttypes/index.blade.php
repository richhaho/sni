...
@section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        <h1 class="page-header">Attachment Type List</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Add Attachment Type</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-12 form-group">
                                            <label>Attacment Type Name:</label>
                       ...
                       @endif
                        <div class="col-md-8">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Attachments Types</h4>
                                </div>
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            @if($type->type == "custom")
                                            @component('researcher.attachmenttypes.components.deletemodal')
                                                @slot('id') 
                                                    {{ $type->slug }}
                                                @endslot
                                                @slot('type_name') 
