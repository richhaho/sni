...
<div id="page">
    ...
    <p class="text-justify" style="margin-top: 10px;">
       ...
       of $ {{number_format($unpaid_balance,2)}} (including interest if contract permits) 
    ...
    <p>
        WITNESS my hand and official seal in the County and State last aforesaid this ____ day of ______________________, {{ isset($year) ? $year :'' }}.
    </p>
   <div class="row">
       <table style="width: 100%">
           <tr>
