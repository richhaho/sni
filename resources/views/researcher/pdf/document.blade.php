...
@foreach($pdf_pages as $page)
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.acol',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.acol',$page)
    </div>
    @endif
    
    @if($page['type'] == 'claim-of-lien')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.col',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.col',$page)
    </div>
    @endif
    
     @if($page['type'] == 'conditional-waiver-and-release-of-lien-upon-final-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.cwarolufp',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.cwarolufp',$page)
    </div>
    @endif
    
     @if($page['type'] == 'conditional-waiver-and-release-of-lien-upon-progress-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.cwarolupp',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.cwarolupp',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.cfpa',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.cfpa',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.nob',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.nob',$page)
    </div>
    @endif
    
      @if($page['type'] == 'notice-of-commencement')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.noc',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.noc',$page)
    </div>
    @endif
    
    @if($page['type'] == 'notice-to-owner')
        <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
            @include('researcher.pdf.nto',$page)
        </div>
        <div class="col-6 form-section">
            @include('researcher.pdf.forms.nto',$page)
        </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.ntoback',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.ntoback',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.nococapb',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.nococapb',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.nocol',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.nocol',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.nonp',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.nonp',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.nonwitlaf',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.nonwitlaf',$page)
    </div>
    @endif
    ...
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.psol',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.psol',$page)
    </div>
    @endif
    
    @if($page['type'] == 'satisfaction-of-lien')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.sol',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.sol',$page)
    </div>
    @endif
    
     @if($page['type'] == 'waiver-and-release-of-lien-upon-final-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.warolufp',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.warolufp',$page)
    </div>
    @endif
    
    @if($page['type'] == 'waiver-and-release-of-lien-upon-progress-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.warolupp',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.warolupp',$page)
    </div>
    @endif
    
     @if($page['type'] == 'waiver-of-right-to-claim-against-bond-final-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.wortcabfp',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.wortcabfp',$page)
    </div>
    @endif
    
     @if($page['type'] == 'waiver-of-right-to-claim-against-bond-progress-payment')
    <div class="col-6 pdf-section" id="{{$page['type'].$page['page_id']}}">
        @include('researcher.pdf.wortcabpp',$page)
    </div>
    <div class="col-6 form-section">
        @include('researcher.pdf.forms.wortcabpp',$page)
    </div>
    @endif
          ...
          $.ajax({
           ...
           success: function(data)
           {
               if (data =='kicked') {
                    ...
                    window.location.replace("{{ url('researcher/workorders/kickout')}}");
               } else {
