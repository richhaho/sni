...
@section('fields')
    ...
    <div class="row">
        <div class="form-group">
            <label>Amend Reason: </label>
            {!! Form::textarea('amend_reason',preg_replace('/\<br(\s*)?\/?\>/i', "\n",$amend_reason),['class'=>'form-control','rows'=>5])!!}
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-xs-6">
        <div class="form-group">
            <label>Originally OR Book #: </label>
            {!! Form::text('original_or_book',$original_or_book,['class'=>'form-control noucase'])!!}
        </div>
        </div>
        <div class="col-xs-6">
        <div class="form-group">
            <label>Originally Recorded Date: </label>
            {!! Form::text('original_date',$original_date,['class'=>'form-control date-picker', 'data-date-format' => 'mm/dd/yyyy'])!!}
        </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="col-xs-6">
        <div class="row">
            ...
            <div class="form-group">
                ...
                {!! Form::text('interest_amount',$interest_amount,['class'=>'form-control'])!!}
            </div>
        </div>
        <div class="row">
            <div class="form-group">
    ...
    <div class="row col-xs-12">
        <div class="col-xs-4">
        <div class="form-group">
            <label>Notice to Owner Date: </label>
