...
<div id="page">
    ...
    <p class="text-justify">That the undersigned, as authorized agent for  {{$client_company_name}}, hereby 
        ...
        of the Recorder of {{ $job_county }} COUNTY, Florida, on {{ $lien_date }}
        in Official Records {{ $field_book_page_number }}, and hereby directs 
        the Recorder to cancel the Claim of Lien.  The Real Property is owned by
        {{ $land_owner_name }} and is legally described as follows:
    </p>
    <p>&nbsp;</p>
