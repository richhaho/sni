  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Delete Work Order Type</h4>
      </div>
      <div class="modal-body">
          <p>Are you sure you want to delete this Work Order Type:<br> {{ $type_name }}</p>
      </div>
      <div class="modal-footer">
          
        
        {!! Form::open(['route' => ['workordertypes.destroy',$id]]) !!}
