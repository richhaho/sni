...
@section('content')
        ...
        <div id="top-wrapper" >
            ...
            <div class="container-fluid">
                ...
                <div class="col-xs-8">
                    {!! Form::open(['route' => 'researcher.invoices.submitpayment', 'id' => 'pay-form'])!!}
                    ...
                    <div class="col-xs-4 pull-right">
                            <button type="submit" class="btn btn-success btn-block form-control"> <i class="fa fa-money"></i> &nbsp; Charge Client ${{number_format($total_charge,2)}}
