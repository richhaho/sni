...
@section('content')
    {!! Form::open(['route' => ['associates.update',$entity->id,$associate->id], 'method'=> 'PUT','autocomplete' => 'off']) !!}
        @if($back <> '')
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-xs-12 form-group">
                                    <label>Email:</label>
                                    <input name="email" value="{{ old("email",$associate->email)}}" class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="150">
                                </div>
                                </div>
                    ...
                    <div class="col-xs-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12 col-lg-6 form-group">
                                    <label>City:</label>
                                    <input name="city"  value="{{ old("city", $associate->city)}}" class="form-control" data-toggle="tooltip" data-placement="top" title="" maxlength="50">
                                </div>
