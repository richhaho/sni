...
<br>
{!! Form::open(['route'=>['workorders.edit',$id],'method'=> 'GET','autocomplete' => 'off','class' => 'form-inline'])!!}
...
<br>
                        ...
                        @endif
<div class="row">
    {!! Form::open(['route' => ['pdfpage.AttachPDF',$id],'files' => true]) !!}
    ...
    {!! Form::open(['route' => ['pdfpage.AttachPDF',$id],'autocomplete' => 'off','class' => 'attachPDF']) !!}
