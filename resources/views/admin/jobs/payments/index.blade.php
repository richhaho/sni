...
<div class="col-xs-12 col-md-4">
    ...
    {!! Form::open(['route' => ['jobpayments.store',$job->id],'files' => true]) !!}
    ...
    {!! Form::close() !!}
    @else
        {!! Form::open(['route' => ['jobpayments.update',$job->id,$xpayment->id], 'method'=> 'PUT', 'id'=> 'edit_payment_form' . $xpayment->id,'files' => true]) !!}
         <div class="col-xs-12 form-group">
             <label>Paid Date: <span class="text-danger">*</span></label>
