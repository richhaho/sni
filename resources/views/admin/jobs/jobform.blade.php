                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    {!!  Form::select('legal_description_source',[''=>'', 'TR'=>'TR', 'NOC'=>'NOC', 'PA'=>'PA'],old("legal_description_source", $job->legal_description_source), ['class' => 'form-control']) !!}
                                </div>
                                </div>
...
<div class="modal " id="modal_multiple_response" tabindex="-1" role="dialog" style="display: block !important;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {!! Form::open(['url' => route('jobs.select_property',$job->id)]) !!}
