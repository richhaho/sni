                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-4 form-group">
                                        ...
                                        <input name="source_date" value="{{$associate->source_date ? date('m/d/Y', strtotime($associate->source_date)):''}}" data-date-autoclose="true" class="form-control date-picker" data-date-format = "mm/dd/yyyy" data-toggle="tooltip" data-placement="top" title="">
                                    </div>
                                    <div class="col-md-12 col-lg-4 form-group">
                                        <label>Source:</label>
                                        <br>
                                        {!! Form::select('source_select',['TR' => 'TR', 'NOC' => 'NOC', 'CL' => 'CL', 'OTHR' => 'OTHR', 'SBZ' => 'SBZ'], explode(',', $associate->source) ,['class' => 'multi-select-source form-control', 'multiple'=>'multiple'])!!}
                                        <input type="hidden" name="source" class="source-content" value="{{$associate->source}}">
                                    </div>
                                </div>
