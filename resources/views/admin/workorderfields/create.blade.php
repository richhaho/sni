...
@section('content')
    {!! Form::open(['route' => 'workorderfields.store','autocomplete' => 'off']) !!}
        {!! Form::hidden('status','open')!!}
        <div id="top-wrapper" >
            <div class="container-fluid">
            <div  class="col-xs-12">
                <h1 class="page-header">Create New Work Order Field
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 form-group">
                                        ...
                                        {!!  Form::select('workorder_type',$wo_types,old("workorder_type","notice-to-owner"), ['class' => 'form-control','id'=>'workorder_type']) !!}
                                    </div>
                                    <div class="col-xs-12 col-md-6 form-group">
                                    <label>&nbsp;</label>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 form-group">
                                     <label>Field Order:</label>
                                          {!!  Form::number('field_order',old("field_order",0), ['class' => 'form-control', 'min'=>'0',  'step'=>'1']) !!}
                                    </div>
                                    <div class="col-xs-12 col-md-6 form-group">
                                        <label>Field Type:</label>
                                        {!!  Form::select('field_type',$field_type,old("field_type","textbox"), ['class' => 'form-control','id'=>'field_type']) !!}
                                    </div>
                                    <div class="col-xs-12 col-md-6 form-group">
                                        <label>Field Label:</label>
                                        <input id="field_label" type="text" class="form-control noucase" name="field_label" required autofocus>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                  <table class="table lines">
                                    <!-- <tr class="new-line-1"><td>
                                       <div class="col-xs-5 form-group">
                                           <label>Value</label>
                                           <input name="new_name[1]" value="" placeholder="Item's name" class="form-control new_name noucase" data-toggle="tooltip" data-placement="top" title="" required autofocus>
                                       </div>
                                       <div class="col-xs-5 form-group">
                                           <label>Label</label>
                                           <input name="new_value[1]" value="" placeholder="Item's Value" class="form-control new_value noucase" data-toggle="tooltip" data-placement="top" title="" required autofocus>
                                       </div>
                                       
                                       <div class="col-xs-1" form-group">
                                           <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                           <a href="#" class="btn btn-danger delete-line"  data-id="1"><i class="fa fa-trash"></i> Delete</a>
                                       </div>
                                      </td></tr> -->
                                    </table>
                                </div>
