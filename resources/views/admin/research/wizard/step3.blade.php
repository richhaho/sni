...
@section('content')
  {!! Form::open(['route' => ['research.wizard.step3.update',$job->id], 'method'=> 'PUT', 'id'=> 'wizard_form','autocomplete' => 'off']) !!}
  <div id="top-wrapper" >
    <div class="container-fluid">
      <div  class="col-xs-12">
          <h1 class="page-header">Research Wizard Step 3 
              <div class="pull-right">
                  <a class="btn btn-danger " href="{{ route('research.wizard.step2', $job->id) }}"><i class="fa fa-times-circle"></i> Back</a>
                  @if($job->type=='public')
