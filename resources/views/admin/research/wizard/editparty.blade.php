...
@section('content')
            ...
            <div  class="col-xs-12">
                <h1 class="page-header">Edit {{ $parties_type[$job_party->type] }}  <small> from {{ $job_party->job->name }}</small>
                    <div class="pull-right">
                        ...
                        <a class="btn btn-danger " href="{{$from=='stepedit' ? route('research.edit',$job_party->job->id).'?#parties' : route('research.wizard.'.$from,$job_party->job->id)}}"><i class="fa fa-times-circle"></i> Cancel</a> &nbsp;&nbsp;
                    </div>
                </h1>       
            </div>
            </div>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                @endif
                {!! Form::open(['route' => ['research.wizard.parties.update',$job_party->job_id,$job_party->id], 'method'=> 'PUT', 'id'=> 'edit_form','autocomplete' => 'off']) !!}
