...
@section('content')
{!! Form::open(['route' => ['research.wizard.step1.update',$job->id], 'method'=> 'PUT', 'id'=> 'wizard_form','autocomplete' => 'off']) !!}
      ...
      <div  class="col-xs-12">
          <h1 class="page-header">Research Wizard Step 1 
              <div class="pull-right">
                  <a class="btn btn-danger " href="{{ route('research.edit', $job->id) }}"><i class="fa fa-times-circle"></i> Back</a>
