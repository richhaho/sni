      ...
      <div  class="col-xs-12">
          <h1 class="page-header">Edit Job Research
              <div class="pull-right">
                  ...
                  @if($work_order == '')
                  <a class="btn btn-danger " href="{{ route('research.index') }}"><i class="fa fa-times-circle"></i> Back</a>
                  @else
                  ...
                  <a href="{{ route('research.wizard.step1',$job->id)}}" class="btn btn-primary btn-property-search"><i class="fa fa-cogs"></i> Research Wizard</a>
          ...
          <div class="modal fade" id="modal-job-property-search" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['research.save_property',$job->id]]) !!}
          ...
          <div class="modal fade" id="modal-mark-complete-research" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['research.mark_completed',$job->id]]) !!}
                <div class="modal-body">
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-12 form-group">
      ...
      <div class="col-xs-12">
          ...
          <div class="tab-content">
               <div role="tabpanel" class="tab-pane active" id="jobform">
                @include('admin.research.jobform')
              </div>
              <div role="tabpanel" class="tab-pane" id="parties">
                  @include('admin.research.components.jobparties-tab')
              </div>
              <!-- <div role="tabpanel" class="tab-pane" id="changes">
                  @include('admin.research.changes.index', ['changes' => $job->changes()->orderBy('added_on','des')->get()])
              </div>
              <div role="tabpanel" class="tab-pane" id="payments">
                 @include('admin.research.payments.index', ['payments' => $job->payments()->orderBy('payed_on','des')->get()])
              </div>
              <div role="tabpanel" class="tab-pane" id="workorders">
                @include('admin.research.workorders.index',['works' => $job->workorders()->where('status', '!=', 'temporary')->get()])
              </div>
              <div role="tabpanel" class="tab-pane" id="questions">
                @include('admin.research.workorders.question',['works' => $job->workorders()->where('status', '!=', 'temporary')->get()])
              </div> -->
              ...
              <div role="tabpanel" class="tab-pane" id="attachments">
                @include('admin.research.components.attachments-tab')
              </div>
          </div>
      </div>
     <!-- /.notes -->
...
$('.full_address').keydown(function(e){
  ...
  if(e.keyCode==32 && full_address && full_address.indexOf(' ')<0){
    ...
    $.get('{{route("research.getaddress")}}?county='+county+'&address_1='+full_address , function( data ) {
