                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="pull-right">
                            <a href="{{route('pricelist.download')}}" class="btn btn-warning"> <i class="fa fa-download"></i> Download CSV</a>
                            @component('admin.pricelist.components.uploadmodal')
                            @endcomponent
                        </div>
                    </div>
                    <div>&nbsp;</div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->price }}</td>
                                            <td>
                                                    @component('admin.pricelist.components.deletemodal')
                                                        @slot('id') 
                                                            {{ $item->id }}
                                                        @endslot
                                                        @slot('item_name') 
                                                        ...
                                                        @endslot
                                                    @endcomponent
                                                    @include('admin.pricelist.components.editmodal')
