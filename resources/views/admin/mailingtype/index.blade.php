...
@section('content')
            ...
            <div  class="col-xs-12">
                <h1 class="page-header">Mailing Type Definitions
                    <div class="pull-right">
                        ...
                        <a href="{{route('mailingtype.download')}}" class="btn btn-warning"> <i class="fa fa-download"></i> Download CSV</a>
                        @component('admin.mailingtype.uploadmodal')
                        @endcomponent
                    </div>
                </h1>
            </div>
        ...
        {!! Form::open(['route' => ['mailingtype.update'], 'method'=> 'POST', 'id'=> 'edit_form','autocomplete' => 'off']) !!}
        <div id="page-wrapper">
            <div class="container-fluid">
