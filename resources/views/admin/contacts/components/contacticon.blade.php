<div class="col-xs-12 col-sm-6 col-md-2">
    ...
    <p><i class="fa fa-envelope-o  fa-fw"></i> {!! $contact->full_address !!}</p>
        ...
        @endif
         ...
         @if($contact->status == 0 ) 
         <a href="{{ route('associates.enable',[$entity->id,$contact->id]) . '?page=1' }}" class="btn btn-warning btn-xs" role="button" data-toggle="tooltip" data-placement="right" title="Enable"><i class="fa fa-check"></i> Enable</a>
         @else
         <a href="{{ route('associates.disable',[$entity->id,$contact->id]) . '?page=1'}}" class="btn btn-warning btn-xs" role="button" data-toggle="tooltip" data-placement="right" title="Disable"><i class="fa fa-ban"></i> Disable</a>
