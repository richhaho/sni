                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        {!!  Form::select('notification_setting',$notification_setting,old('notification_setting','immediate'), ['class' => 'form-control','data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'']) !!}
                                    </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-6 col-lg-3 form-group">
                                    ...
                                    {!!  Form::select('address_type',$address_type,old('address_type',$current_addresstype), ['class' => 'form-control','data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'']) !!}
                                </div>
                                <div class="col-md-6 col-lg-3 form-group">
