                                ...
                                <table class="table lines">
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-1 form-group">
                                                    ...
                                                    <input type="number" {{ old("line_type." . $line->id,$line->type) == 'additional-service' ? 'readonly' :'' }} min="1" name="quantity[{{$line->id}}]" value="{{ old("quantity." . $line->id,$line->quantity)}}" placeholder="Qty" class="form-control quantity" data-toggle="tooltip" data-placement="top" title="">
                                                </div>
                                    ...
                                    <tr class="new-line-{{$key}}"><td>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-1 form-group">
                                                <label>Quantity</label>
                                                <input type="number" {{ old('new_line_type')[$key] == 'additional-service' ? 'readonly' :'' }} min="1" name="new_quantity[{{$key}}]" value="{{old('new_quantity')[$key]}}" placeholder="Qty" class="form-control new_quantity" data-toggle="tooltip" data-placement="top" title="">
                                            </div>
                                            <div class="col-xs-2 form-group">
                                                <label>Price</label>
    ...
    <div class="new-template">
        <tr class="new_line@i"><td>
            <div class="row">
                <div class="col-xs-3 form-group">
                    <label>Type</label>
                    {{ Form::select('new_line_type[@i]',$line_types,'',['class'=>'form-control', 'onchange'=>'changeNewLine(this)'])}}
                    </div>
                <div class="col-xs-5 form-group">
                    <label>Description</label>
                ...
                <div class="col-xs-1 form-group">
                    <label>Quantity</label>
                    <input type="number" value="1" min="1" name="new_quantity[@i]" value="" placeholder="Qty" class="form-control new_quantity" data-toggle="tooltip" data-placement="top" title="">
                </div>
                <div class="col-xs-2 form-group">
                    <label>Price</label>
