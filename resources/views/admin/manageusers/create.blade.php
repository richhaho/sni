...
@section('content')
    {!! Form::open(['route' => 'users.store','autocomplete' => 'off']) !!}
        ...
        <div id="top-wrapper" >
            ...
            <div  class="col-xs-12">
                <h1 class="page-header">New Admin User
                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-xs-12  col-md-3 form-group restrict-group hidden">
                                    <label>Researcher Role:</label>
                                    {!!  Form::select('restricted',['0' =>'Unrestricted', '1'=> 'Restricted'],old("restricted"), ['class' => 'form-control']) !!}
                                </div>
                                </div>
