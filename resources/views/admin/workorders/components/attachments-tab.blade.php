   <div class="row">
    {!! Form::open(['route' => ['workorders.addattachment',$work->id],'files' => true,'class'=>'uploadfile']) !!}
    <div class="col-md-4">
        <div class="col-md-12 form-group filegroup">
            <label>New File:</label>
            {!!  Form::file('file','', ['class' => 'form-control myfile','id'=>'myfile']) !!}
        </div>
    ...
    <div class="col-md-8">
        @foreach ($work->attachments as $attach)
            ...
            <div class="col-md-3 text-center">
                 <div class="thumbnail">
                     <a href="{{ route('workorders.showattachment',[$work->id,$attach->id])}}">
                    <img class="img-responsive" src="{{ route('workorders.showthumbnail',[$work->id,$attach->id])}}" alt="{{ $attach->type }}">
                    </a>
                    <div class="caption">
                      ...
                      <p>
                        ...
                        @component('admin.workorders.components.deleteattachmentmodal')
                            @slot('id') 
                                {{ $attach->id }}
                            @endslot
                            @slot('file_name') 
