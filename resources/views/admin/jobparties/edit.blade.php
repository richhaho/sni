...
@section('content')
        ...
        <div id="top-wrapper" >
            ...
            <div class="container-fluid">
                ...
                @endif
                {!! Form::open(['route' => ['parties.update',$job_party->job_id,$job_party->id], 'method'=> 'PUT', 'id'=> 'edit_form','autocomplete' => 'off','files' => true]) !!}
                                ...
                                <div class="row">
                                    <div class="col-lg-12 form-group">
                                        ...
                                        @if (count($job_party->firm->contacts->where('primary',2))>0 || $job_party->contact->entity->hot_id>0)
                                            {!!  Form::text('company_name',$job_party->contact->entity->firm_name, ['class' => 'form-control','style'=>'pointer-events:none;opacity: 0.7;']) !!}
                                        @else
