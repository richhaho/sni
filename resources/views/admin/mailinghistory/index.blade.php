                    ...
                    <div class="page-header col-xs-12">
                       ...
                       <div class="col-xs-12" id="filters-form">
                            ...
                            <button class="btn btn-success" type="submit" ><i class="fa fa-filter"></i> Enter</button>
                             <a href="{{ route('mailinghistory.resetfilter') }}" class="btn btn-danger">Clear</a>
                            {!! Form::close() !!}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        @component('admin.mailinghistory.components.deletemodal')
                                        @slot('id') 
...
$('.btn-resend').click(function(){
    ...
    $('.btn-resend').css('pointer-events','none');
});
