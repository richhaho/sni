        ...
        <div id="top-wrapper" >
            ...
            <div  class="col-xs-12">
                <h1 class="page-header">
                    <h1 class="page-header">Invoice Batch : #{{$batch_id}} --- Invoice{{count($invoices)>1 ? 's' :''}} Payment 
            ...
            <div class="container-fluid">
                ...
                <div class="col-xs-8">
                    {!! Form::open(['route' => 'invoicesbatches.submitpayment', 'id' => 'pay-form'])!!}
                    ...
                    <div class="col-xs-12 form-group">
                        <button type="submit" class="btn btn-success btn-pay pull-right"> <i class="fa fa-money"></i> &nbsp; Pay ${{number_format($total_charge,2)}}
                             by Credit Card </button>
                    </div> 
                    
                    </form>
                    {!! Form::open(['route' => 'invoicesbatches.submitcheck','method'=> 'GET', 'id' => 'paymentcheck-form'])!!}
                        {{ Form::hidden('batch_id', $batch_id) }}
                    <div class="col-xs-12">
                            <div class="col-xs-12 form-group">
                            <label>Check Number :</label><input type="text" name="check_number" class="form-control" value="" />
                            </div>
                            <style>.btn{margin-right:5px}</style>
                            <div class="col-xs-12 form-group"> 
                                <a href="{{ route("invoicesbatches.index") }}" class="btn btn-danger pull-right"><i class="fa fa-close"></i> Cancel</a>
                                
                                <button type="submit" class="btn btn-success btn-pay pull-right"> <i class="fa fa-money"></i>&nbsp; Pay by Check  
                               </button>
                            </div>
                    </div>
                    </form>
