        ...
        <div id="top-wrapper" >
            <div class="container-fluid">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 pull-right">
                            ...
                            <a style="margin-right: 5px" class="btn btn-danger pull-right btn-back" href="{{ route('invoicesbatches.index')}}"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp;Back&nbsp;&nbsp;</a>
                    </div>
                </div>
            ...
            <div  class="col-xs-12">
                <div class="page-header">
                    ...
                    <h5 class="pull-right">
                        {{\App\CompanySetting::first()->name}}<br>{!! nl2br(\App\CompanySetting::first()->address) !!}<br />Batch Date: {{$batch_date}}<br /><br>{{$client_company}}</h5>
                    <p>
